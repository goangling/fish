...
### 3.1.4 ThinkCMF
[ThinkCMF](https://www.thinkcmf.com/)一款基于ThinkPHP+MYSQL开发的中文内容管理框架。
...
用户登录|	手机号<br>微信<br>微博<br>QQ|邮箱注册、手机注册和邀请<br>微信、QQ、新浪|手机、邮箱、微博、QQ、微信
机构管理员登录||
机构成员登陆|组成一个圈子||
...
动态|短文微博、长文公众号文章<br>发动态、查看权限、评论、点赞、分享||朋友圈，包括用户动态、系统推荐动态<br>点赞、评论、转发、收藏、举报、分享、置顶、删除、
圈子管理|建、入、退、公告、动态、活动||点赞、评论、收藏、分享、删除和浏览量
圈子活动|建、入、退、公告、动态、分享||发布动态
搜索|地区、模糊搜索结果、归属版块||搜分享、搜人、搜圈子，帖子
我的消息|消息、通知||为评论我的，赞我的， 审核通知消息，系统在线助手<br>通知栏目显示最新的消息通知
我的积分||积分对应不同等级| 排行：用户，问答，动态，资讯四
我的活动|||我的圈子
我的交流|关注/帖子/回复/提问/收藏||我的投稿、问答
我的装备|||钱包
签到|签到后的奖励，如兑吧||排行<br> 积分
商户管理|商家<br>钓场||NA
其他特色功能|||话题<br>找伙伴、定位
