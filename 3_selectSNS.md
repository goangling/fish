...
机构管理员登录||
机构成员登陆|组成一个圈子||
基本资料设置|邮箱<br>头像<br>昵称<br>地域<br>签名信息<br>绑定手机号|支持头像、密码
个性资料设置|感兴趣的钓法，钓技|
个人身份设置|机构（装备商户/钓场主/官方机构）<br>机构下成员|支持多个身份、权限不同<br>个人、企业、组织机构认证|
论坛版块|关注、排序、搜索、删除、置顶|[论坛Pro版](http://os.opensns.cn/book/index/read/id/5.html),付费下载，回复可见<br>获取论坛分类/列表<br>关注论坛版块/置顶/推荐<br>详情/回复/楼中楼回复/发布回复<br>编辑帖子/发布帖子/收藏帖子||
论坛帖子|文字、图片、视频、附件<br>表情、链接、字体<br>发帖、编辑、评论、删除、收藏、分享、精华||
百科提问|问题分类<br>提问、编辑、追问、采纳、分享|
百科回复|回复、邀请、点赞、打赏、收藏、分享、删除|
资讯|H5，用户添加、管理员添加<br>投稿、更新、评论、收藏、分享||
动态|短文微博、长文公众号文章<br>发动态、查看权限、评论、点赞、分享|
圈子管理|建、入、退、公告、动态、活动||
圈子活动|建、入、退、公告、动态、分享|
搜索|地区、模糊搜索结果、归属版块|
我的消息||
